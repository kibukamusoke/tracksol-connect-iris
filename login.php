                            ...
                            <div class="card" data-background="color" data-color="blue">
                                ...
                                <div class="card-content">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter username" name="username" class="form-control input-no-border">
                                    </div>
                                    <div class="form-group">
...
<script src="./assets/js/tvx.js"></script>
