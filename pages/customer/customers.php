...
<div class="collapse navbar-collapse">
    <ul class="nav navbar-nav navbar-right">
        <li>
            <a href="/icustomer" class="btn-rotate">
                <i class="ti-plus"></i>
                <span class="notification">Add New Customer</span>
            </a>
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <table id="bootstrap-table" class="table">
                            ...
                            <th data-field="card no" data-sortable="true">Card #</th>
                            ...
                            <?php
                            $query = $__DB->select('customer', '*', 'status = 1', 'customer_name ASC');
    ...
    $().ready(function () {
        window.operateEvents = {
            ...
            'click .edit': function (e, value, row, index) {
                ...
                window.location.href = "/icustomer/" + row.id + "/modify";
            ...
            'click .remove': function (e, value, row, index) {
                $.ajax({
                    url: '/internal/deleteCustomer',
                    //dataType: 'json',
                    type: 'POST',
                    contentType: 'application/json',
                    data: JSON.stringify({"customer_id": row.id}),
                    processData: false,
                    /*headers: {
