...
<div class="collapse navbar-collapse">
    <ul class="nav navbar-nav navbar-right">
        <li>
            <a href="/isupplier" class="btn-rotate">
                <i class="ti-plus"></i>
                <span class="notification">Add New Supplier</span>
            </a>
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <table id="bootstrap-table" class="table">
                            ...
                            <th data-field="supplier code" data-sortable="true">Code #</th>
    ...
    $().ready(function () {
        window.operateEvents = {
            ...
            'click .edit': function (e, value, row, index) {
                ...
                window.location.href = "/isupplier/" + row.id + "/modify";
            ...
            'click .remove': function (e, value, row, index) {
                $.ajax({
                    url: '/internal/deleteSupplier',
                    //dataType: 'json',
                    type: 'POST',
                    contentType: 'application/json',
                    data: JSON.stringify({"supplier_id": row.id}),
                    processData: false,
                    /*headers: {
